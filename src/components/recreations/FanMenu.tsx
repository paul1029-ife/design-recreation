        ...
        <div className="flex w-full items-end justify-center px-40 py-20 min-h-[580px] relative">
            <div className="relative flex justify-center">
                        ...
                        {isExpanded && menuItems.map((item, index) => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    className="flex items-center gap-3 bg-white rounded-2xl cursor-pointer shadow-sm px-4 py-2.5 font-medium text-gray-800 whitespace-nowrap"
                                >
                                    {item.icon}
                                    {item.label}
                                </motion.div>
                ...
                <motion.button
                    ...
                    className="bg-white flex items-center justify-center rounded-full w-12 h-12 shadow-sm relative z-10"
